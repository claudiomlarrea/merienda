...
Guía sanjuanina de confiterías, cafés y casas de té en toda la provincia. Junta lo que aparece en el mapa con lo que circula por redes o un recorrido por Zonda, Ullum, Calingasta, Jáchal, Iglesia y Caucete — y también los cafés de Capital.
...
- En cada ficha, **Cómo llegar** abre Google Maps con destino al cafecito (usa tu ubicación actual si el teléfono la permite).
...
Las fichas combinan direcciones y horarios públicos (Maps, sitios, notas locales) con locales vistos de recorrido o redes, a veces incompletos. Eso no es un error de carga: es el mapa real de merendar en San Juan. Si un dato está mal, corregilo desde **Sumar un local** o editando `src/lib/places.ts`.
